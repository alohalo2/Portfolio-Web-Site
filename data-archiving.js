const archiving = [
    {
        ...
        contents: [
            ...
            "기본적인 RESTful API와 GraphQL 통합 기능을 포함합니다.",
            "모바일 퍼스트 디자인을 기반으로 설계되었습니다.",
            "사용자 인증 및 권한 관리 기능을 포함합니다.",
        ],
    },
    {
        id: 2,
        ...
        contents: [
            ...
            "CI/CD 파이프라인이 완벽하게 구성되어 있습니다.",
            "React Native를 활용한 모바일 앱 개발 포함.",
            "SEO 최적화 및 성능 분석 도구를 활용한 최적화 수행.",
        ],
    },
    {
        id: 3,
        ...
        contents: [
            ...
            "Vue.js와 TailwindCSS로 프론트엔드 개발.",
            "Docker를 사용하여 컨테이너 기반의 환경 구축.",
            "실시간 데이터 시각화를 제공하는 대시보드 개발.",
        ],
    },
];
